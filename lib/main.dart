              ...
              return Container(
                ...
                child: Column(
                  children: <Widget>[
                    Text(
                      "Ob havoni qidirish",
                      style: TextStyle(fontSize: 30, fontWeight: FontWeight.w500, color: Colors.white70),
                    ),
                    Text(
                      "Bir zumda",
                      style: TextStyle(fontSize: 30, fontWeight: FontWeight.w200, color: Colors.white70),
                    ),
                    SizedBox(
                      height: 24,
                    ),
